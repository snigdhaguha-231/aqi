...
def aqi_gauge(aqi, category, color):
    fig = go.Figure(go.Indicator(
        ...
        gauge={
            ...
            "steps": [
                {"range": [0, 50], "color": "#4CAF5033"},
                {"range": [50, 100], "color": "#8BC34A33"},
                {"range": [100, 200], "color": "#FFC10733"},
                {"range": [200, 300], "color": "#FF980033"},
                {"range": [300, 400], "color": "#F4433633"},
                {"range": [400, 500], "color": "#9C27B033"},
            ],
        },
    ))
